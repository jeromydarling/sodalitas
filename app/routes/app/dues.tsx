...
export async function loader({ request, context }: Route.LoaderArgs) {
  ...
  if (!club) return { club: null, invoices: [], periods: [], summary: null, canWrite: false, today: ctx.today, period: null, suggested: "" };
...
export default function Dues({ loaderData, actionData }: Route.ComponentProps) {
  const { club, invoices, periods, period, summary, canWrite, today, suggested } = loaderData;
