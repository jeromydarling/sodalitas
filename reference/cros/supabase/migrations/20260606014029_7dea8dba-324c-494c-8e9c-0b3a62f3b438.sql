...
jsonb_build_object(
  ...
  'topic_scope_keywords', jsonb_build_array('martial arts school management','dojo operations software','belt rank tracking','tournament management','youth athletics waivers'),
  'schedule', 'monthly')),
...
jsonb_build_object(
  ...
  'topic_scope_keywords', jsonb_build_array('worker cooperative software','1099-PATR filing','patronage distribution','democratic governance tools','cooperative equity tracking'),
  'schedule', 'monthly')),
...
jsonb_build_object(
  ...
  'topic_scope_keywords', jsonb_build_array('makerspace management software','repair cafe community','tool library operations','apprenticeship skill tracking','maker culture news'),
  'schedule', 'monthly')),
...
jsonb_build_object(
  ...
  'topic_scope_keywords', jsonb_build_array('gardening management software','soil and zone intelligence','community garden coordination','seasonal planting guides','horticultural news'),
  'schedule', 'monthly')),
...
jsonb_build_object(
  ...
  'topic_scope_keywords', jsonb_build_array('community land trust software','CLT stewardship','shared-equity housing','CCHD community organizing','affordable housing platform'),
  'schedule', 'monthly')),
...
jsonb_build_object(
  ...
  'topic_scope_keywords', jsonb_build_array('disaster recovery software','humanitarian response platform','mutual aid coordination','emergency preparedness tools','survivor-centered case management'),
  'schedule', 'monthly')),
...
jsonb_build_object(
  ...
  'topic_scope_keywords', jsonb_build_array('rehearsal scheduling software','choir management','theater company operations','ensemble attendance tracking','orchestra rehearsal tools'),
  'schedule', 'monthly')),
...
jsonb_build_object(
  ...
  'topic_scope_keywords', jsonb_build_array('reentry case management software','prison ministry platform','recidivism reduction tools','returning citizen support','criminal justice restoration'),
  'schedule', 'monthly')),
...
jsonb_build_object(
  ...
  'topic_scope_keywords', jsonb_build_array('environmental justice platform','just transition software','climate resilience data','civic coalition CRM','place-based stewardship tools'),
  'schedule', 'monthly')),
...
jsonb_build_object(
  ...
  'topic_scope_keywords', jsonb_build_array('walkability audit tool','pedestrian advocacy platform','courtyard urbanism','streetscape assessment software','human-scale city planning'),
  'schedule', 'monthly')),
...
jsonb_build_object(
  ...
  'topic_scope_keywords', jsonb_build_array('Catholic eldercare platform','pastoral care journal','senior living spiritual care','family caregiver tools','liturgy of attention'),
  'schedule', 'monthly'))
